...
//        countryCodeField.setRequired(true);  
        ...
        DataSourceTextField countryNameField = new DataSourceTextField("courseName", "Curso");  
        countryNameField.setRequired(true);  
  
        DataSourceTextField capitalField = new DataSourceTextField("descricao", "Descricao");  
        ...
        DataSourceTextField continentField = new DataSourceTextField("ementa", "Ementa");  
        ...
        setFields(pkField, countryNameField, capitalField, governmentField,  
